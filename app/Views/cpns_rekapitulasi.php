      ...
      <div class="col-12">
        ...
        <div class="card">
                          ...
                          <div class="alert alert-info alert-dismissible fade show">
                						...
                						<span class="fw-semibold">Perhatian!</span> Pastikan usulan sudah sesuai. Ketika Anda mengunggah Pengantar dan SPTJM, maka Anda tidak lagi dapat menambah/mengubah data.<br>
                            Jika ingin mengubah dokumen, silahkan diunggah ulang.
              				    </div>
                          <?php if(!empty($user->lampiran_cpns)){ ?>
                          <div class="alert alert-warning alert-dismissible fade show">
                						<i class="ph-info me-2"></i>
                						<span class="fw-semibold"><a href="https://docu.kemenag.go.id:9000/sscasn/2024/eformasi/<?= $user->lampiran_cpns?>" target="_blank">Lihat Dokumen</a></div>
                          <?php } ?>

				                	<form action="<?= site_url('cpns/final')?>" method="post" enctype="multipart/form-data">
										<div class="mb-3">
											<label class="form-label">Pengantar Surat Usulan dan SPTJM (Usulan CPNS):</label>
