            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="<?= site_url('pppk/export/0')?>" class="btn btn-success">Export Non ASN</a></li>
                    </ol>
                </div>
    ...
    <div class="row">
      <div class="col-12">
        ...
        <div class="card">
                    ...
                    <?php if(!empty($user->lampiran_pppk)){ ?>
                    <div class="alert alert-warning alert-dismissible fade show">
                      <i class="ph-info me-2"></i>
                      <span class="fw-semibold"><a href="https://docu.kemenag.go.id:9000/sscasn/2024/eformasi/<?= $user->lampiran_pppk?>" target="_blank">Lihat Dokumen</a></div>
                    <?php } ?>
